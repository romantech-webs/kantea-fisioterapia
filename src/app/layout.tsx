  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="kantea-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Kantéa Fisioterapia"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="kantea-fisioterapia"
          data-primary-color="#2d4227"
          defer
        ></script>
      </head>
